            ...
            <body>
                <div class="container0">
                    <div class="resume_jpn_intro">
                        ...
                        <p class="date">2021年11月23日現在</p>
                        <p class="name">氏名　ベンサム　ポール</p>
                        <h3>■職務要約</h3>
                        <p class="exp_overview_p">
                            日英堪能のITプロとして、次のステージのキャリアへ進んでいく覚悟ができています。情報提供のシステム・プラットフォームの効率化やスケールアップの過程で、一流企業が直面する課題に対応するためにチームを率いていくという、より総合的な役割にシフトしていくことは、私の興味と強みを活かせる仕事だと思います。
                        </p>
                        <p class="exp_overview_p">
                            現在までの経験・経歴は、2014年6月より2018年下旬にかけて4年間弱、日本の三大銀行のそれぞれの米拠点らにPM兼BAとして携わってきました。採用形態はいつも「契約社員」として活動し、そして「プロジェクト」という範囲で参加させてもらいました。殆ど例外なく入らせてもらったきっかけはソフト開発循環の結合テストの時期にたどり付き、人材ニーズが一番ピークとなっている期間であるから、タイミング的に私みたいな英日堪能兼情報システムの幅広い知識のあるタイプの人材が特に役に立てるかと思います。
                        </p>
                        <p class="exp_overview_p">
